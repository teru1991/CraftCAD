...
use craftcad_io_bridge::{load_diycad_to_internal_model, save_internal_model_to_diycad, LoadDiycadOptions, SaveDiycadOptions};
...
fn e2e_dxf_import_save_reopen_export_svg_reimport_hash_match() {
    ...
    assert_eq!(h1, h3, "normalize hash should match after dxf->save(.diycad)->reopen->export svg->reimport");
}
